...
import { Eye, EyeOff, Mail, Lock, User, ArrowRight } from 'lucide-react' // Import Eye, EyeOff, Mail, Lock, User, ArrowRight icons
      ...
      <div className="relative z-10 w-full max-w-md">
          ...
          <Form {...form}>
            ...
            >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white/90 font-medium">First Name</FormLabel>
                    <FormControl>
                      <div className="relative group">
                        <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/60 group-hover:text-purple-400 transition-colors duration-300 z-10" />
                        <Input 
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-white/90 font-medium">Last Name</FormLabel>
                    <FormControl>
                      <div className="relative group">
                        <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-white/60 group-hover:text-purple-400 transition-colors duration-300 z-10" />
                        <Input 
        ...
        <div className="text-center mt-6">
          <p className="text-white/70">
            ...
            <a href="/login" className="text-purple-400 hover:text-purple-300 transition-colors font-semibold">
              Login
            </a>
          </p>
        </div>
